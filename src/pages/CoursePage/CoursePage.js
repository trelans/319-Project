        ...
        <div className={"perfectCentered"} style={{border:"solid 2px black"}}  >
            <table className={classes["pp-table2"]}  >
                ...
                <tr>
                    ...
                    <td  colSpan={2}    >
                        <h6 className={classes["pp-text-other"] } className={"perfectCentered"}> Bilkent University</h6>
                    </td>
            ...
            <div>
                ...
                <table className={classes["pp-table2"] } style={{width: "95%"}} >
                    ...
                    <tr >
                        ...
                        <td className={classes["pp-text-other"] } style={{borderRight : "solid 2px black"}}>35234</td>
                    ...
                    <tr >
                        ...
                        <td className={classes["pp-text-other"]}style={{borderRight : "solid 2px black"}}>https://www.google.com/</td>
