...
function LearningAgreementBeforeMobility1(props) {
    ...
    return (
        <div>
                ...
                <div className={styles.learningAgreement3}>
                    <Grid container justifyContent="center">
                        ...
                        <Grid item xs={4}>
                            ...
                            <LABMSendingInstution
                                id={formID}
                                fields={sendingInstitutionInfo}
                            ></LABMSendingInstution>
                        </Grid>
                        ...
                        <Grid item xs={12}>
                            ...
                            <LABMReceivingInstution
                                id={formID}
                                fields={receivingInstitutionInfo}
                            ></LABMReceivingInstution>
                        </Grid>
                    </Grid>
                </div>
            ...
            <div className="perfectCentered">
                <Link to="/learning-agreement-2-3" state={state}>
