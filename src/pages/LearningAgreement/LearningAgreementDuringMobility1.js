  ...
  return (
    <div>
      ...
      <div className="ip-container">
        <h1 className="ip-h1">
          Learning Agreement During Mobility Part 1 of 2:
        </h1>
        <div className={styles.learningAgreement3}>
          ...
          <p id="description" className="blackLetter">
            ...
            responsible person in the sending institution and the responsible
            person in the receiving institution)
          </p>
          <TableA></TableA>
          ...
          <p id="description" className="blackLetter">
            (to be approved by e-mail or signature by the student and the
      ...
      <div className="perfectCentered">
        <Link to="/learning-agreement-d-2-2">
