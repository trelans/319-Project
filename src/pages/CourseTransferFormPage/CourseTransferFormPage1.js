  ...
  return (
      <div>
        ...
        <div className="pafp-container">
          <h1 className="pafp-h1">Course Transfer and Exemption Form for Undergraduate Students Part 1 of 2</h1>
            ...
            <table className="pafp-se">
              <tr>
                    <td className="pafp-td" >
                      <div style={{display:"grid" , gridTemplateColumns: "0.5fr 0.7fr " , margin:"auto" , marginLeft: 12}}>
              ...
              <tr>
                ...
                <td rowSpan={3} >
                  <tr > <p> Name of the institution from which courses are transferred  </p></tr>
                </td>
                <td className="pafp-td" >
                  <div style={{display:"grid" , gridTemplateColumns: "0.5fr 0.7fr " , margin:"auto" , marginLeft: 12}}>
