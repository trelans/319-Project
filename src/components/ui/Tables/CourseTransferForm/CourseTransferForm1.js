                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th className="text-center">
                      {" "}
                      ECTS Credits for Erasmus Exchange Students
                    </th>
                    <th className="text-center"> Grade </th>
                    <th className="text-center">
                      {" "}
                      Course Code and Name for a Required Course, Elective Group
                      Name for an Elective Requirement
                    </th>
                    <th className="text-center"> Credits</th>
                    <th className="text-center">
                      {" "}
                      Elective Requirement Exemptions only: Course code(s) of
                      directly equivalent course(s), if any
                    </th>
                    <th />
                  </tr>
                </thead>
