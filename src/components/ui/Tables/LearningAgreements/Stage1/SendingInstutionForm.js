...
export default class App extends React.Component {
  constructor(props) {
    ...
    this.updateInputContactPersonName =
      this.updateInputContactPersonName.bind(this);
    this.updateInputContactPersonEmail =
      this.updateInputContactPersonEmail.bind(this);
    this.updateInputContactContactPersonPhoneNumber =
      this.updateInputContactContactPersonPhoneNumber.bind(this);
