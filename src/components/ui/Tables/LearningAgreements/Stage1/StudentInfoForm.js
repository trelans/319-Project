...
export default class App extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            gender: props.fields.gender ? {
                ...
                label: props.fields.gender.charAt(0).toUpperCase() + props.fields.gender.substring(1, props.fields.gender.length)
            } : {"value": "male", "label": "Male"},
    ...
    handlerComplete = (e) => {
        ...
        const studentInfo = {
            ...
            dateOfBirth: date? date.getFullYear() + "/" + date.getMonth() + "/" + date.getDate() : "",
