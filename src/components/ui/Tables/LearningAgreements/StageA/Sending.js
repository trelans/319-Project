                        ...
                        <div className="col-md-12 column">
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <th className="text-center"> Title of recognised component (as indicated in the course catalogue) at the sending institution </th>
                                    <th className="text-center"> Number of ECTS credits
                                        (or equivalent)
                                    </th>
                                    <th className="text-center"> Sending Institution Grade
                                        (if applicable)
                                    </th>
